      ...
      <View style={styles.profileScreen}>
        ...
        <View style={[styles.body, styles.bodyPosition]}>
          <View style={styles.account}>
            ...
            <TouchableOpacity
              style={[styles.card5, styles.cardLayout, styles.cardBg]}
            >
            ...
            <TouchableOpacity
              style={[styles.card10, styles.cardLayout, styles.cardBg]}
            >
            ...
            <TouchableOpacity style={[styles.card11, styles.cardLayout]}>
          ...
          <View style={[styles.system, styles.bodyPosition]}>
            ...
            <TouchableOpacity
              style={[styles.card12, styles.cardLayout, styles.cardBg]}
            >
            ...
            <TouchableOpacity
              style={[styles.card13, styles.cardLayout, styles.cardBg]}
            >
