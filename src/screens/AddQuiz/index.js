...
const AddQuiz = ({ navigation }) => {
  ...
  const validate = () => {
    ...
    if (!value.question) {
      handleError(
        t("validation.required", { name: t("add_quiz.question") }),
        "question"
      );
      isValid = false;
    } else if (value.question.length > 255) {
      handleError(
        t("validation.max", { name: t("add_quiz.question"), max: "255" }),
        "question"
      );
      isValid = false;
    }
    ...
    if (!value.a) {
      handleError(t("validation.required", { name: t("add_quiz.a") }), "a");
      isValid = false;
    } else if (value.a.length > 255) {
      handleError(
        t("validation.max", { name: t("add_quiz.a"), max: "255" }),
        "a"
      );
      isValid = false;
    }
    ...
    if (!value.b) {
      handleError(t("validation.required", { name: t("add_quiz.b") }), "b");
      isValid = false;
    } else if (value.b.length > 255) {
      handleError(
        t("validation.max", { name: t("add_quiz.b"), max: "255" }),
        "b"
      );
      isValid = false;
    }
    ...
    if (!value.c) {
      handleError(t("validation.required", { name: t("add_quiz.c") }), "c");
      isValid = false;
    } else if (value.c.length > 255) {
      handleError(
        t("validation.max", { name: t("add_quiz.c"), max: "255" }),
        "c"
      );
      isValid = false;
    }
    ...
    if (!value.d) {
      handleError(t("validation.required", { name: t("add_quiz.d") }), "d");
      isValid = false;
    } else if (value.d.length > 255) {
      handleError(
        t("validation.max", { name: t("add_quiz.d"), max: "255" }),
        "d"
      );
      isValid = false;
    }
    ...
    if (!value.answer) {
      handleError(
        t("validation.required", { name: t("add_quiz.answer") }),
        "answer"
      );
      isValid = false;
    } else if (value.answer.length > 255) {
      handleError(
        t("validation.max", { name: t("add_quiz.answer"), max: "255" }),
        "answer"
      );
      isValid = false;
    }
    ...
    if (!value.categoryId) {
      handleError(
        t("validation.required", { name: t("add_quiz.category") }),
        "categoryId"
      );
      isValid = false;
    } else if (value.categoryId.length > 255) {
      handleError(
        t("validation.max", { name: t("add_quiz.category"), max: "255" }),
        "categoryId"
      );
      isValid = false;
    }
  ...
  const handleSubmit = async () => {
    try {
      const response = await api.post("/quiz", value, {
        headers: {
      ...
      if (response.data.status == "success") {
        notification(
          t("axios.success", {
            action: t("add_quiz.added", { question: value.name }),
          }),
        ...
        <View style={styles.card}>
          <View>
            ...
            <TextInput
              ...
              placeholder={t("add_quiz.question_placeholder")}
              editable={!disabled}
          ...
          <View>
            ...
            <TextInput
              ...
              placeholder={t("add_quiz.a_placeholder")}
              multiline={true}
              numberOfLines={4}
              editable={!disabled}
              value={value.a}
          ...
          <View>
            ...
            <TextInput
              ...
              placeholder={t("add_quiz.b_placeholder")}
              multiline={true}
              numberOfLines={4}
              editable={!disabled}
              value={value.b}
          ...
          <View>
            ...
            <TextInput
              ...
              placeholder={t("add_quiz.c_placeholder")}
              multiline={true}
              numberOfLines={4}
              editable={!disabled}
              value={value.c}
          ...
          <View>
            ...
            <TextInput
              ...
              placeholder={t("add_quiz.d_placeholder")}
              multiline={true}
              numberOfLines={4}
              editable={!disabled}
              value={value.d}
          ...
          <View>
            ...
            <TextInput
              ...
              placeholder={t("add_quiz.answer_placeholder")}
              multiline={true}
              numberOfLines={4}
              editable={!disabled}
              value={value.answer}
          ...
          <View>
            ...
            <TextInput
              ...
              placeholder={t("add_quiz.category_placeholder")}
              multiline={true}
              numberOfLines={4}
              editable={!disabled}
...
// Path: src\screens\AddQuiz\index.js
